...
GPT on track as it would basically would say, "Oooo, is that a butterfly? It
...
dictionary, speeding symbol search up dramatically and focusing is view.
...
Codex is just GPT but has no access to the memories that I gave it through the
